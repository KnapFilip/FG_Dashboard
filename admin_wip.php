...
if ($role_id != 1 && $role_id != 2) {
    // Pokud uživatel nemá správnou roli, přesměruj ho na jinou stránku (např. domů)
    header("Location: dashboard.php"); // nebo jinou stránku, na kterou se má uživatel dostat
    exit();
}
?>
<!DOCTYPE html>
                    ...
                    <li class="dropdown">
                        <?php if (isset($_SESSION['role_id']) && ($_SESSION['role_id'] == 1 || $_SESSION['role_id'] == 2)): ?>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="admin_wip.php" class="Active">WIP</a></li>
                            </ul>
                        <?php endif; ?>
                    </li>
